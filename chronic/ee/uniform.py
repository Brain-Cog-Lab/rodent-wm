...
def main_work():
    ...
    for one in para:
        ...
        plt.savefig("./ee/no-bio/ee%f.jpg"%(one[11]))
        plt.close()
        ...
        np.savez('./ee/no-bio/ee%f.npz'%(one[11]),**array_dict)


        
        
        e_neron_record.append(e_neuron_all.i)
        e_t_record.append(e_neuron_all.t)
        i_neron_record.append(i_neuron_all.i)
        i_t_record.append(i_neuron_all.i)
