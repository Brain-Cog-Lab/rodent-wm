...
def main_work():
    ...
    for three in range(3):
        for two in range(10):
            ...
            input_i_4=PoissonInput(P_I, 's_AMPA_ext', C_selection, rate_selection, 'stimuli4(t)')
            ...
            plt.savefig("./ei/no-bio/ei%f-%d.jpg"%(Wei_self,three))
            plt.close()
            ...
            np.savez('./ei/no-bio/ei%f-%d.npz'%(Wei_self,three),**array_dict)
