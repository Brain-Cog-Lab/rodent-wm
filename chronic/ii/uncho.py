...
def main_work():
    ...
    for three in range(2):
        for two in range(10):
            ...
            input_i=PoissonInput(P_I, 's_AMPA_ext', C_selection_i, rate_selection, 'stimuli(t)')
            ...
            size=5
            e_spike.append(e_neuron)
            t_e_spike.append(t_e)
            i_spike.append(i_neuron)
            t_i_spike.append(t_i)
            ampa_scale_record.append(ampa_scale)
            nmda_scale_record.append(nmda_scale)
            ...
            plt.savefig("./ii/uncho/+ii%f-%d.jpg"%(C_selection_i,three))
            plt.close()
            ...
            np.savez('./ii/uncho/+ii%f-%d.npz'%(C_selection_i,three),**array_dict)
